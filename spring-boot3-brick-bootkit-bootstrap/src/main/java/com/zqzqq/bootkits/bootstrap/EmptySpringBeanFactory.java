...
public class EmptySpringBeanFactory implements SpringBeanFactory {
    ...
    @Override
    public <A extends Annotation> java.util.Set<A> findAllAnnotationsOnBean(String beanName, Class<A> annotationType, boolean allowFactoryBeanInit) throws NoSuchBeanDefinitionException {
