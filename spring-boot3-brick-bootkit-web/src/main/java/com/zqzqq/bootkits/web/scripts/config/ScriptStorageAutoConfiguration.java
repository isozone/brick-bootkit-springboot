...
@Slf4j
@Configuration
@ConditionalOnProperty(prefix = "plugin.scripts", name = "enabled", havingValue = "true", matchIfMissing = true)
...
public class ScriptStorageAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "plugin.scripts.storage", name = "type", havingValue = "file", matchIfMissing = true)
    ...
    @ConditionalOnMissingBean(name = "scriptStorage")
    @ConditionalOnProperty(prefix = "plugin.scripts.storage", name = "type", havingValue = "jdbc")
    @Primary
    ...
    @ConditionalOnProperty(prefix = "plugin.scripts.storage", name = "type", havingValue = "custom")
